...
class LoginForm(AuthenticationForm):
    ...
    password=forms.CharField(label=_('Password'),strip=False,widget=forms.PasswordInput(attrs={'autocomplete':'currunt-password','class':'form-control'}))
...
class MyPasswordResetForm(PasswordResetForm):
    email = forms.EmailField(label=_("Email"), required=True, max_length=254,widget=forms.EmailInput(attrs={"class": "form-control",'autocomplete':'email'}))
